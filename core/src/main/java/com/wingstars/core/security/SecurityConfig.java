    ...
    public SecurityFilterChain filterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/cheerleaders/**", "/api/files/**", "/api/ranking-categories/**", "/uploads/**", "/api/banners/**").permitAll()
                        .requestMatchers("/api/admin/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/ranking-categories/**", "/api/banners/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/ranking-categories/**", "/api/banners/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/ranking-categories/**", "/api/banners/**").hasRole("ADMIN")
